function [allstate,selectstate,spec,yinres,dtw]=runAlignmentExampleGen(filename, midiname, numNotes, stateOrd2, noteNum, means, covars, learnparams,width,targetsr,nharm,winms)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [allstate selectstate spec yinres]=runAlignment(audiofile,midifile,...
...
hop = 32;
[audiofile, sr] = audioread(filename);

% normalize audio file
audiofile=audiofile/sqrt(mean(audiofile.^2))*.6;
 
%get vals
[align, yinres, spec,dtw] = getVals(filename, midiname, audiofile, sr, hop,width,targetsr,nharm,winms);
