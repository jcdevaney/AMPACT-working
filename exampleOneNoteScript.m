...
% run the alignment
[allstate,selectstate,spec,yinres,dtw]=runAlignment(audiofile, midifile, numNotes, stateOrd, noteNum, means, covars, learnparams);
...
dlmwrite('exampleOneNote.txt',[times.ons' times.offs'], 'delimiter', '\t');
