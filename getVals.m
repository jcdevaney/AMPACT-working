function [res, yinres, spec,dtw]=getVals(filename, midifile, audiofile, sr, hop,width,targetsr,nharm,winms)
...
[res,spec,dtw] = runDTWAlignment(filename, midifile, 0.025,width,targetsr,nharm,winms);
